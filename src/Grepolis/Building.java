...
public class Building {
    ...
    public enum BuildingType {
        academy("Academy", "You can conduct research at the academy. Grepolis offers you various technologies that can fortify your troops, make your construction skills more effective or give you new battle techniques. The higher the upgrade level of your academy, the more technologies you can discover."),
        ...
        barracks("Barracks", "In the barracks you can recruit regular troops and mythical units. The higher the upgrade level of the barracks, the more quickly you can train your troops."),
        ...
        farm("Farm", "The farm provides your workers and troops with food. You have to upgrade the farm for your city to grow. The higher the upgrade level of the farm, the more residents can be provided for - and the more troops you can feed."),
        docks("Harbor", "The harbor is where you can upgrade your naval fleet. You can construct naval transport units as well as naval combat units. The speed with which your naval units are constructed depends on the upgrade level of the harbor."),
        ...
        main("Senate", "In the Senate you can have new buildings erected or existing buildings upgraded. The higher the Senate level, the more quickly the construction work is done."),
        ironer("Silver mine", "In the silver mine your workers are scraping the precious silver ore that is used to mint the silver coins. The higher the upgrade level of the mine, the more silver coins can be minted."),
        temple("Temple", "At the temple you can worship a god of your choice. Each of the Grepolis gods can enact different Divine Powers and bring different mythical units to life. For both of these you will need a Divine favor that is created by the worshiped god in the temple. The higher the upgrade level of the temple, the more Divine favor you receive from the gods."),
        ...
        lumber("Timber camp", "In the dense forests outside your polis, your lumberjacks are harvesting the massive amounts of lumber that is needed to upgrade your city and supply your troops. The higher the upgrade level of the timber camp, the more usable wood is produced by your lumberjacks."),
        storage("Warehouse", "Your city's resources are stored in the warehouse. The higher the upgrade level of the warehouse, the more resources can be stored there. Each upgrade level protects 100 of each resource against being looted.");
